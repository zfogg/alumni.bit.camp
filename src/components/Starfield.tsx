...
export const Starfield: React.FC<StarfieldProps> = ({ count = 150, speed = 0.5, className = '' }) => {
  ...
  return <canvas ref={canvasRef} className={`starfield ${className}`} style={{ display: 'block' }} />
}
