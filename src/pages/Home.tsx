  ...
  return (
    <div className="min-h-screen bg-space text-cream pb-20">
      ...
      <section className="max-w-5xl mx-auto px-6 py-32 text-center mb-8">
        ...
        <p className="text-2xl text-cream mb-16">Eleven years of builders. One community.</p>
        ...
        <div className="rounded-card p-12 text-center" style={{ backgroundColor: "#1A2E33" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <input
              ...
              className="sm:flex-1 px-4 py-3 rounded-card bg-space border border-teal text-cream placeholder-muted focus:outline-none focus:border-orange"
            />
            <input
              type="number"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {alumni.map((person) => (
            <Card key={person.initial} className="text-center p-6">
              <div
                className={`w-20 h-20 ${person.color} rounded-full mx-auto mb-4 flex items-center justify-center`}
              >
              ...
              <p className="text-cream text-xs mt-3">
