  ...
  return (
    <div className="min-h-screen bg-space text-cream pt-20 pb-20">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-5xl font-display font-bold text-white mb-12 text-center">Join Bitcamp Alumni</h1>
        ...
        <Card className="p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-cream mb-2">Year(s) Attended</label>
              <input
                type="number"
                placeholder="2020"
