...
const TABS: Record<string, string[]> = {
  Members: [
    'id', 'name', 'email', 'year', 'role', 'school',
    'what_i_did', 'headshot_url', 'linkedin', 'github', 'website',
    'created_at', 'featured', 'approved',
  ],
  Contacts: [
  ...
  Supporters: [
    'id', 'name', 'email', 'type',
    'donation_range', 'message',
    'prize_name', 'prize_description', 'prize_criteria', 'preferred_year',
