...
if (!GOOGLE_SERVICE_ACCOUNT_EMAIL || !GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY || !GOOGLE_SHEETS_ID) {
  ...
  console.error("  GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY:", GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY ? "✓" : "✗");
...
async function addWinners() {
  ...
  const winnersData = [
    ...
    ["gurpreet-social-good", "2023", "CodeForGood", "FoodBridge — surplus food redistribution", "", ""],
    ["gurpreet-social-good", "2022", "Impact X", "MedAlert — medication reminder for elderly", "", ""],
    ["best-ai-innovation", "2024", "Neural Nexus", "CodeAssist — AI code review tool", "", ""],
    ["best-ai-innovation", "2023", "ML Masters", "PredictFlow — predictive analytics platform", "", ""],
