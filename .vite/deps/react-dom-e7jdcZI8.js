import { n as __commonJSMin, t as require_react } from "./react-CYOr8xvk.js";
...
var require_scheduler_development = /* @__PURE__ */ __commonJSMin((exports) => {
  (function () {
    ...
    if (
      ...
      __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(/* @__PURE__ */ new Error());
    ...
    if (
      ...
      __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(/* @__PURE__ */ new Error());
  })();
});
//#endregion
...
var require_react_dom_development = /* @__PURE__ */ __commonJSMin((exports) => {
  (function () {
    ...
    function typeName(value) {
      return (
        (typeof Symbol === "function" && Symbol.toStringTag && value[Symbol.toStringTag]) ||
    ...
    var warnUnknownProperties = function (type, props, eventRegistry) {
      ...
      for (var key in props)
        if (!validateProperty$1(type, key, props[key], eventRegistry)) unknownProps.push(key);
    ...
    function startTransition(setPending, callback, options) {
      ...
      try {
        ...
        if (prevTransition === null && currentTransition._updatedFibers) {
          if (currentTransition._updatedFibers.size > 10)
            warn(
    ...
    function checkClassInstance(workInProgress, ctor, newProps) {
      ...
      if (
        ...
        !didWarnAboutLegacyContext$1.has(ctor) &&
    ...
    function updateFunctionComponent(current, workInProgress, Component, nextProps, renderLanes) {
      ...
      var context = getMaskedContext(
        workInProgress,
        getUnmaskedContext(workInProgress, Component, true),
      );
      var nextChildren;
      var hasId;
      prepareToReadContext(workInProgress, renderLanes);
    ...
    function mountIndeterminateComponent(_current, workInProgress, Component, renderLanes) {
      ...
      var context = getMaskedContext(
        workInProgress,
        getUnmaskedContext(workInProgress, Component, false),
      );
      prepareToReadContext(workInProgress, renderLanes);
      var value;
      var hasId;
    ...
    function updateSuspenseListComponent(current, workInProgress, renderLanes) {
      ...
      if (hasSuspenseContext(suspenseContext, ForceSuspenseFallback)) {
        ...
        if (current !== null && (current.flags & DidCapture) !== NoFlags)
    ...
    function completeWork(current, workInProgress, renderLanes) {
      ...
      switch (workInProgress.tag) {
        ...
        case LegacyHiddenComponent:
          ...
          if (current !== null) {
            if ((current.memoizedState !== null) !== nextIsHidden && !enableLegacyHidden)
      ...
      while (nextEffect !== null) {
        ...
        if (fiber.tag === OffscreenComponent && isModernRoot) {
          var newOffscreenSubtreeIsHidden =
            fiber.memoizedState !== null || offscreenSubtreeIsHidden;
          if (newOffscreenSubtreeIsHidden) {
            ...
            var newOffscreenSubtreeWasHidden =
              (current !== null && current.memoizedState !== null) || offscreenSubtreeWasHidden;
    ...
    function captureCommitPhaseErrorOnRoot(rootFiber, sourceFiber, error) {
      var root = enqueueUpdate(
        rootFiber,
        createRootErrorUpdate(rootFiber, createCapturedValueAtFiber(error, sourceFiber), SyncLane),
        SyncLane,
      );
      var eventTime = requestEventTime();
      if (root !== null) {
    ...
    var topLevelUpdateWarnings = function (container) {
      ...
      if (!!(rootEl && getInstanceFromNode(rootEl)) && !isRootRenderedBySomeReact)
        error(
    ...
    function hydrate(element, container, callback) {
      ...
      if (isContainerMarkedAsRoot(container) && container._reactRootContainer === void 0)
        error(
    ...
    function unmountComponentAtNode(container) {
      ...
      if (container._reactRootContainer) {
        var rootEl = getReactRootElementInContainer(container);
        if (rootEl && !getInstanceFromNode(rootEl))
          error(
...
//# sourceMappingURL=react-dom-e7jdcZI8.js.map
